#!/bin/bash
# This is the Shell-Script to launch EC2 instance by AWS CLI+shell
set -euo pipefail
...
main() {
    ...
    SUBNET_ID="subnet-0dea9fa7025cdb211"
    SECURITY_GROUP_IDS="sg-0dbaf956e22b74228"  # Add your security group IDs separated by space
